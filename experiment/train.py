...
class ArgParse(object):
    def __init__(self):
        ...
        parser.add_argument("-ff", "--feature_file", default="posts_content_all_features_[CLS]_SUM_joined")
        parser.add_argument("-lf", "--label_file", default="posts_reactions_all_joined")
        parser.add_argument("-wf", "--weight_file", default=None)
        parser.add_argument("-tf", "--task_file", default="posts_content_all_text_ids_joined")
        parser.add_argument("--topic_file", default="posts_content_topics_pkl_withids")
        ...
        parser.add_argument("-M", "--Model", default="fc")
        ...
        parser.add_argument("-nr", "--num_repeats", default=5, type=int)
        self.parser = parser
